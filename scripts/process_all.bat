...
echo.
echo. >> "%LOGFILE%"
powershell -NoProfile -Command "[Console]::OutputEncoding=[System.Text.Encoding]::UTF8; py -u '%SCRIPTS%process_results.py' '%BASE%\CharlesTown\ct-results-2026\%PDF%' CT 2>&1 | Out-File -FilePath '%LOGFILE%' -Encoding utf8 -Append"
...
echo.
echo. >> "%LOGFILE%"
powershell -NoProfile -Command "[Console]::OutputEncoding=[System.Text.Encoding]::UTF8; py -u '%SCRIPTS%process_results.py' '%BASE%\Fairmount Park\fp-results-2026\%PDF%' FP 2>&1 | Out-File -FilePath '%LOGFILE%' -Encoding utf8 -Append"
...
echo.
echo. >> "%LOGFILE%"
powershell -NoProfile -Command "[Console]::OutputEncoding=[System.Text.Encoding]::UTF8; py -u '%SCRIPTS%process_results.py' '%BASE%\Gulfstream Park\gp-results-2026\%PDF%' GP 2>&1 | Out-File -FilePath '%LOGFILE%' -Encoding utf8 -Append"
...
echo.
echo. >> "%LOGFILE%"
powershell -NoProfile -Command "[Console]::OutputEncoding=[System.Text.Encoding]::UTF8; py -u '%SCRIPTS%process_results.py' '%BASE%\Evangeline Downs\evd-results-2026\%PDF%' EVD 2>&1 | Out-File -FilePath '%LOGFILE%' -Encoding utf8 -Append"
