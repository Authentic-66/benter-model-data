...
:run
echo Processing LRL: %PDF%
echo Processing LRL: %PDF% >> "%LOGFILE%"
echo.
echo. >> "%LOGFILE%"
py -u "%SCRIPTS%process_results.py" "%RESDIR%\%PDF%" LRL > "%TEMP%\results_tmp.txt" 2>&1
